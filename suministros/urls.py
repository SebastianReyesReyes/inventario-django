...
urlpatterns = [
    ...
    path('movimiento-pack/nuevo/', views.movimiento_pack_create, name='movimiento_pack_create'),
    path('ajax/pack-siblings/', views.ajax_get_pack_siblings, name='ajax_pack_siblings'),
